...
public interface ProdutoContrllerOpeAapi extends ControllerCroossOring {
	...
	ResponseEntity<Page<ProdutoListagemDTo>> listar(String parametro, Integer pagina, Integer size, Pageable page);
	...
	@ApiResponses(value = { @ApiResponse(responseCode = "201", description = "Produto salvo com sucesso"),
	 ...
	 ResponseEntity<ProdutoDto> criar(@Param(value = "corpo") ProdutoInput produto,HttpServletResponse response);
