...
import com.comanda.model.dto.ArquivoDto;
...
public interface FotoProdutoControllerOpenApi extends ControllerCroossOring{
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "201", description = "Foto produto  criada com sucesso", content = {
					@Content(mediaType = "application/json", schema = @Schema(implementation = ArquivoDto.class)) }),
