		...
		public Page<Produto> listarProdutos(String parametro, Pageable pageable) {
			 String baseQuery = "SELECT p.id FROM Produto p "  ;
		        ...
		        if (parametro != null && !parametro.isEmpty()) {
		             condition = " WHERE p.nome LIKE :parametro OR p.marca.nomeMarca LIKE :parametro OR p.subgrupo.nomeSubgrupo LIKE :parametro OR p.subgrupo.grupo.nomeGrupo LIKE :parametro";
		        }
